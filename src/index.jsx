...
class Typeahead extends React.Component {
  ...
  constructor(props) {
    ...
    Typeahead.bindFn.forEach((fn)=> this[fn] = this[fn].bind(this));
  }
...
Typeahead.bindFn = ['getResults', 'handleChange', 'handleSelected', 'keyEvent', 'handleKeyDown', '_onEnter', '_onUp', '_onDown'];
